...
<div class="box">
	...
	<div id="contain">	 
		<div id="nowCoinSection">
			...
			<input type="text" value="${ent.ent_coin }" id="ent_coin" readonly disabled="disabled">
	...
	<div class="modal-dialog ">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<input type="number" id="ent_coin_refund"  required="required">
...
//	});
				...
				if(rsp.success){
					...
					$.ajax({
                        ...
                        success : function(){
                            ...
                            alert('결제성공');
                            location.href = "${contextPath}/ent/entMain";
                         }
                });
	...
	var ent_coin = 0;
	var ent_coin_refund = 0;
	
	$("#coin_refund").on("click",function(){
		ent_coin = $("#ent_coin").val();
		
		
		console.log(ent_coin);
		console.log(ent_coin_refund);
	...
	$('#modalYes').click(function(){
		...
		ent_coin_refund = $("#ent_coin_refund").val();
		
		if(ent_coin_refund == 0){
			alert('다시 입력해주세요');
			console.log(ent_coin);
			console.log(ent_coin_refund);
		}
		else if(ent_coin < ent_coin_refund){
			alert('코인이 부족합니다.');
			console.log(ent_coin);
			console.log(ent_coin_refund);
		}
