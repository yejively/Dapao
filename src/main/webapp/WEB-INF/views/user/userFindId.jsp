	...
	<div class="container">
		...
		<div class="login-content">
				...
				<div class="input-div one">
                 ...
                 <div class="div">
					<input type="text" name="us_name" class="input" placeholder="Name" required="required" >  
					</div>
              </div>
              <div class="input-div pass">
                 ...
                 <div class="div">
					<input type="text" name="us_tel" class="input" required="required" placeholder="phone Number">  
					 </div>
              </div>
