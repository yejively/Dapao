	...
	<div class="container">
		...
		<div class="login-content">
              ...
              <div class="input-div pass">
                 ...
                 <div class="div">
					<input type="password" name="us_pw" class="input" placeholder="Password" required="required">  
					 </div>
              </div>
					<input type="submit" class="btn" value="로그인">
					<input type="button" class="btn1" value="회원가입 바로가기" onclick="location.href='/user/userJoin';">
					<input id="a" class="btn2" type="button" value="아이디찾기" onclick="location.href='/user/userFindId';">
					<!-- <input type="button" class="btn3" value="비밀번호찾기" id="findPwBtn11"> -->
					<input id="findPwBtn11" class="btn3" type="button" value="비밀번호찾기" onclick="location.href='/user/userFindPw';">
				</form>
		</div>
    </div>
